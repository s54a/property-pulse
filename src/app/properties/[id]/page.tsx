								...
								<main>
									...
									<div className="mt-6 rounded-lg bg-white p-6 shadow-md">
										...
										<ul className="grid list-none grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
											<li>
												<FaCheck className="mt-3 mr-2 text-green-600" /> Wifi
											</li>
											<li>
												<FaCheck className="mt-3 mr-2 text-green-600" /> Full kitchen
											</li>
											<li>
												<FaCheck className="mt-3 mr-2 text-green-600" /> Washer & Dryer
											</li>
											<li>
												<FaCheck className="mt-3 mr-2 text-green-600" /> Free Parking
											</li>
											<li>
												<FaCheck className="mt-3 mr-2 text-green-600" /> Hot Tub
											</li>
											<li>
												<FaCheck className="mt-3 mr-2 text-green-600" /> 24/7 Security
											</li>
											<li>
												<FaCheck className="mt-3 mr-2 text-green-600" /> Wheelchair Accessible
											</li>
											<li>
												<FaCheck className="mt-3 mr-2 text-green-600" /> Elevator Access
											</li>
											<li>
												<FaCheck className="mt-3 mr-2 text-green-600" /> Dishwasher
											</li>
											<li>
												<FaCheck className="mt-3 mr-2 text-green-600" /> Gym/Fitness Center
											</li>
											<li>
												<FaCheck className="mt-3 mr-2 text-green-600" /> Air Conditioning
											</li>
											<li>
												<FaCheck className="mt-3 mr-2 text-green-600" /> Balcony/Patio
											</li>
											<li>
												<FaCheck className="mt-3 mr-2 text-green-600" /> Smart TV
											</li>
											<li>
												<FaCheck className="mt-3 mr-2 text-green-600" /> Coffee Maker
											</li>
										</ul>
									</div>
									<div className="mt-6 rounded-lg bg-white p-6 shadow-md">
